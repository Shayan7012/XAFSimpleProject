...
namespace Solution3.Win {
    ...
    public partial class Solution3WindowsFormsApplication : WinApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static Solution3WindowsFormsApplication() {
        ...
        private void Solution3WindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
